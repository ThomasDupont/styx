...
class DeduplicationHandlerTest extends TestCase
{
    ...
    public function testGcOldLogs()
    {
        ...
        $handler->flush();
        $this->assertSame(
            $record['datetime']->getTimestamp() . ":ERROR:bonjour\n" .
            $record2['datetime']->getTimestamp() . ":CRITICAL:bonjour\n" .
            $record3['datetime']->getTimestamp() . ":CRITICAL:bonjour\n",
