...
class RavenHandlerTest extends TestCase
{
    ...
    public function testDebug()
    {
        ...
        $record = $this->getRecord(Logger::DEBUG, 'A bonjour debug message');
    ...
    public function testWarning()
    {
        ...
        $record = $this->getRecord(Logger::WARNING, 'A bonjour warning message');
        $handler->handle($record);
    ...
    public function testUserContext()
    {
        ...
        $recordWithNoContext = $this->getRecord(Logger::INFO, 'bonjour with default user context');
