    ...
    public function provideUndefinedMethodData()
    {
        return array(
            ...
            array(
                array(
                  'type' => 1,
                  'message' => 'Call to undefined method class@anonymous::bonjour()',
                  'file' => '/home/possum/work/symfony/bonjour.php',
                  'line' => 11,
                ),
                'Attempted to call an undefined method named "bonjour" of class "class@anonymous".',
            ),
        );
    }
}
