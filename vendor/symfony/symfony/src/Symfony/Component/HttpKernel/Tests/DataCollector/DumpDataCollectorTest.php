...
class DumpDataCollectorTest extends TestCase
{
    ...
    public function testCollectHtml()
    {
        ...
        $collector = new DumpDataCollector(null, 'bonjour://%f:%l');
        ...
        if (PHP_VERSION_ID >= 50400) {
            $xOutput = <<<EOTXT
<pre class=sf-dump id=sf-dump data-indent-pad="  "><a href="bonjour://{$file}:{$line}" title="{$file}"><span class=sf-dump-meta>DumpDataCollectorTest.php</span></a> on line <span class=sf-dump-meta>{$line}</span>:
