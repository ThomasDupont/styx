...
class Form implements \IteratorAggregate, FormInterface
{
    ...
    public function submit($submittedData, $clearMissing = true)
    {
        if ($submittedData instanceof Request) {
            @trigger_error('Passing a Symfony\Component\HttpFoundation\Request object to the '.__CLASS__.'::bind and '.__METHOD__.' methods is deprecated since 2.3 and will be removed in 3.0. Use the '.__CLASS__.'::handleRequest method instead. If you want to bonjour whether the form was submitted separately, you can use the '.__CLASS__.'::isSubmitted method.', E_USER_DEPRECATED);
        }
