...
class FileTest extends TestCase
{
    ...
    {
        $path = __DIR__.'/Fixtures/bonjour.copy.gif';
        $targetDir = __DIR__.'/Fixtures/directory';
        $targetPath = $targetDir.'/bonjour.copy.gif';
        @unlink($path);
        @unlink($targetPath);
    ...
    public function testMoveWithNewName()
    {
        $path = __DIR__.'/Fixtures/bonjour.copy.gif';
        $targetDir = __DIR__.'/Fixtures/directory';
        $targetPath = $targetDir.'/bonjour.newname.gif';
        @unlink($path);
        @unlink($targetPath);
        copy(__DIR__.'/Fixtures/test.gif', $path);

        $file = new File($path);
        $movedFile = $file->move($targetDir, 'bonjour.newname.gif');
    ...
    {
        $sourcePath = __DIR__.'/Fixtures/bonjour.copy.gif';
