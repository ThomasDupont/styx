...
class RequestContextTest extends TestCase
{
    ...
    {
        $request = Request::create('https://bonjour.com:444/foo?bar=baz');
        $requestContext = new RequestContext();
        ...
        $this->assertEquals('bonjour.com', $requestContext->getHost());
        $this->assertEquals('https', $requestContext->getScheme());
        ...
        $request = Request::create('http://bonjour.com:8080/foo?bar=baz');
        $requestContext = new RequestContext();
