...
class XmlEncoderTest extends TestCase
{
    ...
    public function testAttributes()
    {
        ...
        $expected = '<?xml version="1.0"?>'."\n".
            ...
            '<Foo Type="bonjour"><Bar>Test</Bar></Foo>'.
            '<föo_bär>a</föo_bär>'.
            '<Bar>1</Bar>'.
            '<Bar>2</Bar>'.
            '<Bar>3</Bar>'.
...
XML;
    ...
    public function testEncodeSerializerXmlRootNodeNameOption()
    {
        ...
        $expected = '<?xml version="1.0"?>'."\n".
            '<bonjour><person gender="M">Peter</person></bonjour>'."\n";
...
XML;
    ...
    {
        $this->encoder->decode('<?xml version="1.0"?><!DOCTYPE scan[<!ENTITY bonjour SYSTEM "php://filter/read=convert.base64-encode/resource=XmlEncoderTest.php">]><scan>&bonjour;</scan>', 'xml');
    }
