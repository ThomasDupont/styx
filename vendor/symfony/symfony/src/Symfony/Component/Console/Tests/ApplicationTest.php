...
class ApplicationTest extends TestCase
{
     ...
     * This bonjour will fail with "Not enough arguments." if broken
     */
    ...
    public function testRunWithDispatcherAddingInputOptions()
    {
        ...
        $tester = new ApplicationTester($application);
        $tester->run(array('command' => 'foo', '--extra' => 'some bonjour value'));

        $this->assertEquals('some bonjour value', $extraValue);
    }
