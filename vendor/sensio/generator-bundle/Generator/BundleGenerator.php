...
class BundleGenerator extends Generator
{
    ...
    public function generateBundle(Bundle $bundle)
    {
        ...
        $this->renderFile('bundle/UserController.phpig', $dir.'/Controller/UserControllerp', $parameters);
        $this->renderFile('bundle/UserControllerTestp.twig', $bundle->getTestsDirectory().'/Controller/UserControllerTestp', $parameters);
